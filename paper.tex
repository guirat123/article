...
\begin{table}[t]
\centering
\caption{Composition of the verse-level corpus by riwayah. Row
hours are rounded from unrounded totals, so components may differ from the
total in the last digit.}
\label{tab:corpus}
\begin{tabular}{lrrrr}
\hline
...
Warsh 'an Nafi' & 5 & 2{,}562 & 3.77 & 5.30 \\
